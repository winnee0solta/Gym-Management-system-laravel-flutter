...
class MemberAppBar extends StatefulWidget {
  MemberAppBar({Key key}) : super(key: key);

  @override
  _MemberAppBarState createState() => _MemberAppBarState();
}

class _MemberAppBarState extends State<MemberAppBar> {
  int noticecount = 0;
  @override
