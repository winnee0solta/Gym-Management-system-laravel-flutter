class ApiHelper {
  static final String domain = "http://192.168.56.1:3000"; 
  ...
  static final String memberUpdateBodyStatus = baseurl + "/member-data/update-body-status"; 
   static final String memberUpdateNutritionPlans = baseurl + "/member-data/update-nutrition-plan";       
   static final String memberUpdateWorkoutPlans = baseurl + "/member-data/update-workout-plan";       
   static final String memberUpdateAttendance  = baseurl + "/member-data/update-attendance";       
   static final String trainerAttendance  = baseurl + "/attendance/trainer";       
   static final String trainerTodaysAttendance  = baseurl + "/attendance/today/trainer";       
