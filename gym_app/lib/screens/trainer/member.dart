...
class TrainerMemberScreen extends StatefulWidget {
  TrainerMemberScreen({Key key}) : super(key: key);

  @override
  _TrainerMemberScreenState createState() => _TrainerMemberScreenState();
}

class _TrainerMemberScreenState extends State<TrainerMemberScreen> {
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TrainerSingleMember(
                memberid: assignedmembers[index]['member_id'].toString(),
              ),
            ),
          );
        },
