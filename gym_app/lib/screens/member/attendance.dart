...
class MemberAttendance extends StatefulWidget {
  MemberAttendance({Key key}) : super(key: key);

  @override
  _MemberAttendanceState createState() => _MemberAttendanceState();
}
...
class _MemberAttendanceState extends State<MemberAttendance> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Chip(
                  backgroundColor: attendances[index]['status'] == 'PRESENT'
                      ? Colors.green
                      : Colors.red,
                  label: Padding(
  ...
  Future<void> _populateData() async {
    ...
    Authentication().userId().then((userId) async {
      var response = await http.get(ApiHelper.memberAttendance + "/" + userId,
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          attendances.clear();
          attendances = data['member_attendances'];
          isloading = false;
        });
      } else {
