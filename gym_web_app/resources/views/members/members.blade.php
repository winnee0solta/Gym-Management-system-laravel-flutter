    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="/members/view/{{$item->id}}" class="btn btn-sm btn-success mr-2" data-toggle="tooltip" title="View Member">
                            <i class="material-icons">visibility</i>
                        </a>
                        <button type="button" class="btn btn-sm btn-dark" data-toggle="modal"
                            data-target="#modal--sendnotice-{{$item->id}}" data-toggle="tooltip" title="Send Notice">
